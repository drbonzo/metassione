...
use NorthslopePL\Metassione2\Tests\Fixtures\Builder\SubNamespace\OtherSimpleKlass;
...
class ClassDefinitionBuilderTest extends PHPUnit_Framework_TestCase
{
	...
	public function testWithNotFoundClassProperty()
	{
		$this->setExpectedException(
			...
			'Class Foo (NorthslopePL\Metassione2\Tests\Fixtures\Builder\Foo) not found for property NorthslopePL\Metassione2\Tests\Fixtures\Builder\TypeNotFoundKlass::fooValue'
		);
	...
	public function testWithNotFoundClassProperty2()
	{
		$this->setExpectedException(
			LogicException::class,
			'Class NorthslopePL\Metassione2\Tests\Fixtures\Builder\Foo (NorthslopePL\Metassione2\Tests\Fixtures\Builder\NorthslopePL\Metassione2\Tests\Fixtures\Builder\Foo) not found for property NorthslopePL\Metassione2\Tests\Fixtures\Builder\TypeNotFoundKlass2::fooValue'
