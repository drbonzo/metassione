...
use NorthslopePL\Metassione2\Tests\Fixtures\Klasses\BasicTypesOnlyDefinedKlass;
...
use NorthslopePL\Metassione2\Tests\Fixtures\Klasses\UndefinedTypeKlass2;
use stdClass;
...
class POPOObjectFillerTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		$simpleObject = new BasicTypesOnlyDefinedKlass();
		...
		$expectedObject = new BasicTypesOnlyDefinedKlass();
	...
	{
		$simpleObject = new UndefinedTypeKlass2();
		...
		$expectedObject = new UndefinedTypeKlass2();
